...
export default function Policies({policies}:{policies:policyProps[]}){
    return(
        ...
        {policies.map((policy, idx) => (
          <div
            key={idx}
            className="flex flex-col items-center justify-center bg-linear-to-br from-gray-800 to-gray-700 rounded-2xl h-full hover:scale-105 hover:shadow-lg transition-transform px-3"
          >
